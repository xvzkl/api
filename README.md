      ...
      <g transform="translate(427, 90) scale(1, 1) translate(-427, -90)">
        ...
        <path d="" fill="url(#linear)" opacity="0.4" >
         ...
         <text text-anchor="middle" alignment-baseline="middle" x="50%" y="35%" class="text" style="fill:#ffffff;" stroke="#none" stroke-width="1" >Welcome</text>
        <text text-anchor="middle" alignment-baseline="middle" x="50%" y="55%" class="desc" style="fill:#ffffff;">快速构建现代化应用</text>
      </svg>
